...
namespace MechanicShop.Infrastructure.Migrations
{
    ...
    [Migration("20260822112359_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MechanicShop.Domain.WorkOrders.Invoices.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MechanicShop.Domain.WorkOrders.Invoices.Invoice", b =>
                {
                    b.HasOne("MechanicShop.Domain.WorkOrders.WorkOrder", "WorkOrder")
                        .WithOne("Invoice")
                        .HasForeignKey("MechanicShop.Domain.WorkOrders.Invoices.Invoice", "WorkOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsMany("MechanicShop.Domain.WorkOrders.Invoices.InvoiceLineItem", "InvoiceLineItems", b1 =>
                        {
